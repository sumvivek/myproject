package com.google.cloude.vision.samples.labeldetect;
...
public class LabelApp {
   ...
   */
  private static final String APPLICATION_NAME = "Agrovision/1.0";
  ...
  public static void main(String[] args) throws IOException, GeneralSecurityException {
   /* if (args.length != 1) {
    ...
    Path imagePath = Paths.get("D:\\workspace\\alex-knight-wfwUpfVqrKU-unsplash.jpg");
